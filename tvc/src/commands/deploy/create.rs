...
pub async fn run(args: Args) -> Result<()> {
    ...
    let intent = CreateTvcDeploymentIntent {
        ...
        pivot_container_encrypted_pull_secret: Some(deploy_config.pivot_container_encrypted_pull_secret.clone()),
        ...
        host_container_encrypted_pull_secret: Some(deploy_config.host_container_encrypted_pull_secret.clone()),
